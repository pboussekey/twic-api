...
class MessageTest extends AbstractService
{
    ...
    public function testCanGet($conv)
    {
        ...
        $this->assertEquals(count($data['result'][6]) , 9); 
        ...
        $this->assertEquals(count($data['result'][4]) , 9); 
        ...
        $this->assertEquals(count($data['result'][4]['users']) , 3); 
    ...
    public function testCanGetList($conv)
    {
        ...
        $this->assertEquals(count($data['result'][3]['message']) , 1); 
